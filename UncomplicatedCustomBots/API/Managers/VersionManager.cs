...
#nullable enable
        public static async void Init()
        {
            ...
            {
                LogManager.Info($"You are using UncomplicatedCustomBots v{VersionInfo.Name}{(VersionInfo.CustomName is not null ? $" '{VersionInfo.CustomName}'" : string.Empty)}!");
            }
